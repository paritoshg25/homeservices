        ...
        <div class="card-body">
            ...
            <form action="scripts/updatehall.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input value="<?= $provider->email; ?>" id="email" name="email" type="email" class="form-control" placeholder="Email" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select value="<?= $provider->city; ?>" class="form-control" name="city" id="city">
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-2 text-center">
                            <img style=" height: 100px;" src="images/<?= $provider->photo; ?>">
                ...
                <div class="form-group" style="margin-top: 15px;">
                    ...
                    <textarea name="descr" id="descr" class="form-control" cols="30" rows="5" placeholder="Add Discription About Your Hall" required><?= $provider->descr; ?></textarea>
                </div>

                <div class="form-group">
                    <label for="">Password</label>
                    <input value="<?= $provider->password; ?>" id="password" name="password" type="password" class="form-control" placeholder="Enter 4 Charectar Password" minlength="4" required>
                </div>
