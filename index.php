...
$cities = ["Ahmedabad", "Amreli", "Anand", "Bhuj", "Bopal", "Dahod", "Godhra", "Kadi", "Kalol", "Kheda", "Mandvi","Mehsana", "Navsari", "Rajkot", "Vadodara"];
$services = ["Electrician", "Plumber","Home Painting", "Salon for Women","Salon for Men", "AC/Appliance Repair", "Cleaning & Pest Control"];
?>
...
<div class="main">
    ...
    <section class="main-background">
        ...
        <div class="container" style="margin-top: 77px; padding-bottom: 71px;">
